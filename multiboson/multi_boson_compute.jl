...
@save "multiboson/results1/preconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wp res2_wp res3_wp
@load "multiboson/results/preconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wp res2_wp res3_wp
res3_wp[2], size(res3_wp[5])
@load "multiboson/results1/preconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wp res2_wp res3_wp
res3_wp[2], size(res3_wp[5])


res1_wop = ground_state(Hm, ϕ1; do_preconditioning=false, maxiter=5000);
res2_wop = ground_state(Hm, ϕ2; do_preconditioning=false, maxiter=5000);
res3_wop = ground_state(Hm, ϕ3; do_preconditioning=false, maxiter=5000);

@save "multiboson/results1/unpreconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wop res2_wop res3_wop

#c2, μ2 = 1.5, 2.5
#c12 = 0.5
@load "multiboson/results1/unpreconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wop res2_wop res3_wop
@load "multiboson/results1/preconditioned_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).jld2" res1_wp res2_wp res3_wp
@load "multiboson/results1/seperate_computation_$(c1)_$(c2)_$(μ1)_$(μ2).jld2" E_χ4 E_χ8
if c12 == 0.0
        Esep_χ4 = E_χ4
        Esep_χ8 = E_χ8 
else 
...
@show fig
save("multiboson/results1/result_$(c1)_$(c2)_$(c12)_$(μ1)_$(μ2).pdf", fig)