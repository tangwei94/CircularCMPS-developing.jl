...
scatter!(ax1, 1 ./ βs[end-11:end], free_energies[end-11:end], label=L"\text{cMPO, }χ=3")
scatter!(ax1, 1 ./ βs[end-11:end], free_energies2[end-11:end], label=L"\text{cMPO, }χ=9")
...
scatter!(ax2, 1 ./ βs[1:end][end-11:end], entropies[end-11:end], label=L"\text{cMPO, }χ=3")
scatter!(ax2, 1 ./ βs[1:end][end-11:end], entropies2[end-11:end], label=L"\text{cMPO, }χ=9")
...
#lines!(ax2, 1 ./ dtrg_data[:, 1][end-11:end], dtrg_data[:, 4][end-11:end], color=:grey, label=L"\text{XTRG}")
scatter!(ax3, 1 ./ βs[1:end][end-11:end], variances[end-11:end], label=L"\text{cMPO, }χ=3")
scatter!(ax3, 1 ./ βs[1:end][end-11:end], variances2[end-11:end], label=L"\text{cMPO, }χ=9")
axislegend(ax3, position=:rt, framevisible=false)
@show fig

save("J1J2/J1J2_dimer_phase_result_old_results1.pdf", fig)
